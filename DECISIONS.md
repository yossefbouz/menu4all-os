...
**Décision :** l'équipe se réunit **en semaine et le week-end** (quatre créneaux : deux en semaine, deux le week-end), à **16 h (ou 15 h) et 21 h, heure de Tunisie** — les jours restent à confirmer (O-14). Tâches de la semaine : **Idriss et Bayram** mènent la remise Caprice, le rendez-vous Art+ et livrent les derniers QR (tables 31–60) à Cap Grill ; **Youssef** met à jour la présentation Art+ ; **Aziz, Drago et Idriss** fixent les prix des offres marketing. Le site d'équipe (menu4all-os.vercel.app) passe en anglais, calendrier en premier, avec un fil d'actualités et les tâches filtrables par personne.
...
| O-14 | Jours des réunions : lesquels en semaine, lesquels le week-end (créneaux 16 h / 15 h et 21 h, heure de Tunisie) | Tous | D-030, 14/09 |
